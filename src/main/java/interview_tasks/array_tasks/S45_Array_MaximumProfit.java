...
public class S45_Array_MaximumProfit {

    /*
        We are given an array of prices for a given stock.
        ith  element of this array represents the price of the stock on  day i.
    ...
    public static void main(String[] args) {
        defaultSolution(new int[]{ 1, 9, 3, 3, 3, 4, 9, 12, 11});
    }

    private static void defaultSolution(int[] arr){
        int min = arr[0];
