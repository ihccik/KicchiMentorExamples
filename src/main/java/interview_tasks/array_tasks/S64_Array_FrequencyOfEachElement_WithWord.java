...
public class S64_Array_FrequencyOfEachElement_WithWord {
    /*
        Write a program that should count each number and prints a sentence to say how many times a number is repeated.
