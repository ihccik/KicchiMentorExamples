...
public class S28_String_ReverseConsecutiveStrings {
    ...
    /*
        ...
        EXAMPLE:
            input: "test12pop90java989pyt"
            output: tset12pop90avaj989typ
     */

    public static void main(String[] args) {
        System.out.println(defaultSolution1("test12pop90java989pyt"));
    }

    private static String defaultSolution1(String s){
        String temp = "";
